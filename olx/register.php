...
if(!$conn)
{
    ...
    $sql="INSERT INTO users(fname,nitc_email,pass,mobile,type) VALUES ('$t1','$t2','$t4','$t3','$t5')";
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Register
                    <small>as Customer/Seller</small>
                </h1>
				...
				<form method="POST" id="content1" onSubmit="return check()" onReset="hide()" action="<?php htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <div class="control-group form-group">
                        <div class="controls">
                            ...
                            <input type="text" class="form-control" placeholder="Enter Customer/Seller Name" name="fname">
				  ...
				  <label id="cpassmatch" style="color:green;visibility:hidden;">Password Match                         </div>
					...
					<div class="control-group form-group"id="content6">
                        <div class="controls">
                            ...
                            <select id="type" class="form-control" name="type" placeholder="Enter City name" >
								<optgroup>
